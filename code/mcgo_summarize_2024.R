...
###Load in reecapture data from 2024
...
###           TABLE 1 and 2             #####################################
############################################################################
write.csv(ground_sum, "output/2024/ground_based_2024.csv")
write.csv(helicopter_sum, "output/2024/helicopter_based_2024.csv")


################# summary of banded birds from 1990 - 2024 ####################
### Before reading this file into R, make sure to add year 2024 and number of banded birds.
### We do this copying the previous year file and manually input a new row with 2024 information.
############################################################################
###           TABLE 3               #######################################
##########################################################################
mcgo_sum <- read_excel("data/2024/raw_summary_1990_2024.xlsx")
...
write.csv(novel_recaps_table, "output/2024/novel_recaps_table_2024.csv")
